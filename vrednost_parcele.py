...
class vrednost_parcele:
    ...
    def createLayerPath1(self):
        ...
        self.savelayerPath1 = QFileDialog.getOpenFileName(None,"Učitaj parcele", lastDir1, "*.shp")
    ...
    def createLayerPath2(self):
        ...
        self.savelayerPath2 = QFileDialog.getOpenFileName(None,"Učitaj procembene razerde", lastDir2, "*.shp")
    ...
    def createLayerPath3(self):
        ...
        QgsMapLayerRegistry.instance().addMapLayer(label_layer3)
